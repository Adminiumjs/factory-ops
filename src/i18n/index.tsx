 ...
 *
 * Money carries two decimals here, unlike the clinic desk's whole pounds: a
 * works costs a plate in pennies, and rounding a unit cost to the pound would
 * make every margin on the books wrong.
 */
import {
  createContext,
  useCallback,
...
const STORAGE_KEY = "factory-ops-locale";
